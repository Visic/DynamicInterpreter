...
namespace DynamicInterpreter {
    public static partial class DescriptionLanguageInterpreter {
        static IReadOnlyDictionary<string, Parse> _symbolParsers = new Dictionary<string, Parse>() {
			...
			{"escaped_char", Parser.Symbol("escaped_char", Parser.InOrder(Parser.Literal("\\"), Parser.AnyChar()))},
			{"char_or_escaped", Parser.Symbol("char_or_escaped", Parser.Any(Parser.AnyChar(), Parser.FixType(() => _symbolParsers["escaped_char"])))},
			...
			{"allchars_not_quote", Parser.Symbol("allchars_not_quote", Parser.Repeat(Parser.InOrder(Parser.Negate(Parser.Literal("'")), Parser.FixType(() => _symbolParsers["char_or_escaped"])), null, null))},
			...
			{"allchars_not_gt", Parser.Symbol("allchars_not_gt", Parser.Repeat(Parser.InOrder(Parser.Negate(Parser.Literal(">")), Parser.FixType(() => _symbolParsers["char_or_escaped"])), null, null))},
